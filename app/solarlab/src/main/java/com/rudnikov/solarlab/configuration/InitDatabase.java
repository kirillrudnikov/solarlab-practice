...
public class InitDatabase {
    ...
    @Bean
    CommandLineRunner init(UserRepository userRepository, AdvertRepository advertRepository, CommentRepository commentRepository) {

        User firstUser = new User("kirill.rudnikov", "kirillrudnikov811@gmail.com", "+79780371649", "dasha123", UserRole.ADMINISTRATOR);
        User secondUser = new User("nastya.boot", "asya.1997@yandex.ru", "+79781697410", "nastya4.f[D", UserRole.USER);
